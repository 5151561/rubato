...
pt=JSON.parse(java.ajax("https://book.pjxhmy.com/source/"+parseInt(java.getString('$.data.book_id')/1000)+"/"+java.getString('$.data.book_id')+".html,"+JSON.stringify(option))).data[0].site_path
